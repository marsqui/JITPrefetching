...
mv results_workload.txt results/results_put_${size}Mb_${day}.txt

sshpass -p "stackme" ssh  10.30.1.24 "tc qdisc del dev eth0 root" > /dev/null
sshpass -p "stackme" ssh  10.30.1.25 "tc qdisc del dev eth0 root" > /dev/null
sshpass -p "stackme" ssh  10.30.1.26 "tc qdisc del dev eth0 root" > /dev/null

# #100mbit
sshpass -p "stackme" ssh  10.30.1.24 "tc qdisc add dev eth0 root tbf rate 100mbit latency 500ms burst 15400" > /dev/null
sshpass -p "stackme" ssh  10.30.1.25 "tc qdisc add dev eth0 root tbf rate 100mbit latency 500ms burst 15400" > /dev/null
sshpass -p "stackme" ssh  10.30.1.26 "tc qdisc add dev eth0 root tbf rate 100mbit latency 500ms burst 15400" > /dev/null
...
# #200mbit
sshpass -p "stackme" ssh  10.30.1.24 "tc qdisc add dev eth0 root tbf rate 200mbit latency 500ms burst 15400" > /dev/null
sshpass -p "stackme" ssh  10.30.1.25 "tc qdisc add dev eth0 root tbf rate 200mbit latency 500ms burst 15400" > /dev/null
sshpass -p "stackme" ssh  10.30.1.26 "tc qdisc add dev eth0 root tbf rate 200mbit latency 500ms burst 15400" > /dev/null
...
#300mbit
sshpass -p "stackme" ssh  10.30.1.24 "tc qdisc add dev eth0 root tbf rate 300mbit latency 50ms burst 1540"
sshpass -p "stackme" ssh  10.30.1.25 "tc qdisc add dev eth0 root tbf rate 300mbit latency 50ms burst 1540"
sshpass -p "stackme" ssh  10.30.1.26 "tc qdisc add dev eth0 root tbf rate 300mbit latency 50ms burst 1540"
...
#500mbit
sshpass -p "stackme" ssh  10.30.1.24 "tc qdisc add dev eth0 root tbf rate 500mbit latency 500ms burst 15400" > /dev/null
sshpass -p "stackme" ssh  10.30.1.25 "tc qdisc add dev eth0 root tbf rate 500mbit latency 500ms burst 15400" > /dev/null
sshpass -p "stackme" ssh  10.30.1.26 "tc qdisc add dev eth0 root tbf rate 500mbit latency 500ms burst 15400" > /dev/null
...
sshpass -p "stackme" ssh  10.30.1.24 "tc qdisc del dev eth0 root" > /dev/null
shpass -p "stackme" ssh  10.30.1.25 "tc qdisc del dev eth0 root" > /dev/null
sshpass -p "stackme" ssh  10.30.1.26 "tc qdisc del dev eth0 root" > /dev/null
